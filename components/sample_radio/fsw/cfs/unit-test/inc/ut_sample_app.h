 ...
 *
 * Purpose:
 * Extra scaffolding functions for the sample_radio_app unit test
 *
 * Notes:
...
#ifndef UT_SAMPLE_RADIO_APP_H
#define UT_SAMPLE_RADIO_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "SAMPLE_RADIO_APP_Data_t" typedef.
 */
#include "sample_radio_app.h"

/*
 * Allow UT access to the global "SAMPLE_RADIO_APP_Data" object.
 */
// extern SAMPLE_RADIO_AppData_t SAMPLE_RADIO_APP_Data;

#endif /* UT_SAMPLE_RADIO_APP_H */
