module Components {
    ...
    active component Sample_radioSim {
        ...
        @ Command to initialize Sequence Sample_radio HK
        async command SAMPLE_RADIO_SEQ(
        )
        ...
        @ A Count of Successful Commands from FSW to Sample_radio
        telemetry CommandCount: U32

        @ A Count of Unsuccessful Commands from FSW to Sample_radio
