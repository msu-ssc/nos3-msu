#ifndef NOS3_SAMPLE_RADIOHARDWAREMODEL_HPP
#define NOS3_SAMPLE_RADIOHARDWAREMODEL_HPP
...
** Defines
*/
#define SAMPLE_RADIO_SIM_SUCCESS 0
#define SAMPLE_RADIO_SIM_ERROR   1
...
namespace Nos3
{
    ...
    class Sample_radioHardwareModel : public SimIHardwareModel
    {
    public:
        /* Constructor and destructor */
        Sample_radioHardwareModel(const boost::property_tree::ptree& config);
        ~Sample_radioHardwareModel(void);

    private:
        /* Private helper methods */
        void create_sample_radio_hk(std::vector<uint8_t>& out_data); 
        void create_sample_radio_data(std::vector<uint8_t>& out_data); 
        ...
        SimIDataProvider*                                   _sample_radio_dp; /* Only needed if the sim has a data provider */
