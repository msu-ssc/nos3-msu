...
## Generic Radio
##
# gnome-terminal --title="Radio Checkout" -- $DFLAGS -v $BASE_DIR:$BASE_DIR --name $SC_NUM"-generic-radio-checkout" -h nos-fsw --network=$SC_NETNAME -w $BASE_DIR $DBOX ./components/iris_radio/fsw/standalone/build/generic_radio_checkout
# sleep 1
